...
import { createEvent, updateEvent, listEvents, listMyEvents, getEvent, deleteEvent, getStats, getAttendees} from '../controllers/event.controller';
...
// Organizer: list my own events (must be BEFORE /:id to avoid conflict)
router.get('/mine', authenticate, authorize('ORGANIZER'), listMyEvents);
